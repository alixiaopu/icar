...
$(document).ready(function(){
	...
	$(".membermodify").click(function(){
		...
		$('#frmWindow').append('<div class="topBar">会员资料<div class="pwClose"></div></div><div class="border"><iframe frameborder="0" scrolling="no" src="member_modify.php?memberid='+memberid+'" class="Frm"></iframe></div>');
