...
$server   = "http://update.aatee.com/remote/webservice/soapserver.php";
...
<title>安装向导 - Powered by aatee.com</title>
...
if ($step == 0) {
	...
	$unagree = "<input type=\"button\" class='button' value=\"不接受协议\" onClick=\"window.location.href='http://www.aatee.com'\">";
...
PHPWEB软件官方网站：<a href='http://www.aatee.com' target='_blank' >WWW.aatee.com</a>
...
";
	...
	if($_POST['nextstep']!=1){
		$error_msg = "注：请输入您在PHPWEB官方网站的会员登录账号和密码，系统将和您的会员帐户绑定，用于<br />软件升级等远程服务。如果您尚未申请PHPWEB会员帐号，<a href='http://www.aatee.com/member/reg.php' target='_blank' class='un'>点这里立即申请</a><br /><br />";
	}
    ...
    <tr>
      <td width="229" valign="top" align="center"> 
        <table width="100%"  border="0" cellpadding="5" cellspacing="0">
          ...
          <tr> 
            <td height="90" valign="top" style="font-size:12px;color:#ffffff">&nbsp; 
            </td>
          </tr>
          <tr> 
        ...
        <table width="90%" border="0" cellspacing="0" cellpadding="0" align="center">
          <tr> 
            <td align="center"><p style="FONT:bold 12px/20px Verdana, Arial, Helvetica, sans-serif;color:#fff;">Powered By <a href="http://www.aatee.com" style="color:#fff;">aatee.com</a></td>
          </tr>
        </table>
      </td>
